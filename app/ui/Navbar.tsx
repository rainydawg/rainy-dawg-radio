    ...
    return (
        ...
        <nav className="flex justify-between items-center pl-10 pr-10 w-full bg-white pt-5 pb-5">
            ...
            <div className="flex space-x-14">
                ...
                <Link href="/playlist" className="font-mono hover:text-gray-700 font-bold">Playlist</Link>
        ...
        {showSchedule && (
            <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50" onClick={() => setShowSchedule(false)}>
                <div className="relative p-4" onClick={e => e.stopPropagation()}>
                    ...
                    <Image src="/schedule.png" width={900} height={600} alt="Station Schedule" className="object-contain max-h-[90vh] max-w-[90vw] w-auto h-auto"/>
                </div>
            </div>
        )}
        </>
